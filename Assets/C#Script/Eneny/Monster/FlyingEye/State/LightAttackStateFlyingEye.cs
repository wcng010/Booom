...
{
    public class LightAttackStateFlyingEye:FlyingEyeState
    {
        ...
        public override void Enter()
        {
            ...
            _revisionPoint = 
                new Vector2(TransformOwner.localScale.x * FlyingEyeData.LightAttackPosOffSet.x,FlyingEyeData.LightAttackPosOffSet.y) + (Vector2)TargetTrans.position;
        ...
        public LightAttackStateFlyingEye(FlyingEyeBase owner, string nameToTrigger, string animationName) : base(owner, nameToTrigger, animationName)
        {
        }
    }
}